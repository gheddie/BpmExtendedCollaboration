...
public class ProcessHelper {
	...
	public static TrainDepartureData getTrainDepartureData(DelegateExecution execution) {
		return (TrainDepartureData) execution.getProcessEngine().getRuntimeService()
